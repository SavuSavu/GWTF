...
const HELP_TEXT_BY_ID = {
  ...
  dir_alternation: 'Toolpath direction alternation. Never keeps same direction; Every Turn flips each revolution; Every N flips every N turns.',
  dir_alternation_n: 'Number of turns before flipping direction. Only used when alternation is set to Every N Turns.',
  start_direction: 'Starting toolpath direction: counter-clockwise (CCW) or clockwise (CW).',
